  ...
  return (
    <section id="about" >
      <div className={styles.about}>
        ...
        <p>When I'm not coding, you can find me playing volleyball (indoor and beach), snowboarding in Wisconsin or camping out under the stars. I'm a big sports fan and after having been to championship parades for both the Cubs and the Blackhawks, I'm hoping the next one will be for my Chicago Bulls 🤞</p>
      </div>
    </section>
  )
}
